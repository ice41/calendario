...
export function EmployeeList() {
    ...
    const handleAdd = async (data: Omit<Employee, 'id' | 'companyId'>) => {
        await addEmployee({
            ...data,
    ...
    const handleEdit = async (data: Omit<Employee, 'id' | 'companyId'>) => {
        if (editingEmployee) {
            ...
            <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 border-b border-slate-100 pb-6">
                ...
                <div className="flex gap-2">
                    <button
                        ...
                        className="inline-flex items-center gap-2 px-4 py-2 bg-slate-100 text-slate-700 border border-slate-200 rounded-xl hover:bg-slate-200 transition-all font-medium"
                    >
